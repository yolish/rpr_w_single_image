...
from models.nerfmm.utils.training_utils import set_randomness, load_ckpt_to_net
from models.nerfmm.utils.pose_utils import create_spiral_poses
from models.nerfmm.utils.comp_ray_dir import comp_ray_dir_cam_fxfy
from models.nerfmm.utils.lie_group_helper import convert3x4_4x4
...
def parse_args():
    ...
    parser.add_argument('--img_names_file', type=str,
                        default='../../datasets/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_ShopFacade_train.csv')
