...
class CameraPoseDataset(Dataset):
    ...
    def __init__(self, dataset_path, labels_file, data_transform=None, equalize_scenes=False):
        ...
        self.img_paths, self.poses, self.scenes, self.scenes_ids, self.scene_unique_names = read_labels_file(labels_file, dataset_path)
        scene_to_poses = {}
...
def read_labels_file(labels_file, dataset_path):
    ...
    return imgs_paths, poses, scenes, scenes_ids, scene_unique_names